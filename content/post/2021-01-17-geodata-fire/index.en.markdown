...
{{< figure src="NSK_tot.png" title="Количество пожаров в сутки в г. Новосибирске (2016-2020 гг.)" >}}
...
В статье были рассмотрены простейшие возможности языка программирования {{< icon name="r-project" pack="fab" >}} в применении к анализу географических данных по пожарам и их последствиям. Были рассмотрены нанесение на карту:
