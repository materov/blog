...
![Прогнозирование временного ряда на тестовую выборку](ts_ml_forecast_blog.png)
...
![Скорректированный прогноз для различных моделей](ts_ml_forecast_1_year_blog.png)
